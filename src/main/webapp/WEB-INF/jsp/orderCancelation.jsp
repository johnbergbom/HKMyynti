...
<div id="center-top">
 ...
 <li><a href="orderCancelation" class="Chosen"><spring:message code="cancelOrder"/></a></li>
...
<div id="center-mid">
 <h2><spring:message code="cancelOrder"/></h2>
<p><spring:message code="orderCancelation.help1"/></p>
<p><spring:message code="orderCancelation.help2"/></p>

<%-- Give command object a meaningful name instead of using default name, 'command' --%>
<form:form commandName="commandObj" action="${sellerContextPath}/orderCancelation">
