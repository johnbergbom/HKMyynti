...
<div id="center-top">
 ...
 <li><a href="commonBill" class="Chosen"><spring:message code="commonBill"/></a></li>
...
<div id="center-mid">
 <h2><spring:message code="commonBill"/></h2>
<p><spring:message code="commonBill.help1"/></p>
<p><spring:message code="commonBill.help2"/></p>
...
<form:form commandName="commandObj" action="${sellerContextPath}/commonBill">
