...
<form:form commandName="commandObj" action="${sellerContextPath}/newOrder">
	<form:hidden path="marketSalesId"/>
    ...
    <div class="form-item">
       <h4><spring:message code="newOrder.product"/>: ${adTemplateHeadline}</h4>
    </div>
    <div class="form-item">
       <h4><spring:message code="newOrder.url"/>: <a href="${adUrl}">${adUrl}</a></h4>
    </div>
    <div class="form-item">
