...
public class EmailUtils {
	...
	// TODO: insert these constants into the system_email table (system_email.check_email = false) instead
	// of having them hardcoded here.
	...
	private static String SENDER_NAME = "XML Management";
	...
	public static void sendEmail(String body, String subject, Seller seller) throws Exception {
		Session session = getSession();
		MimeMessage message = new MimeMessage(session);
		message.setText(body,"utf-8");
		message.setSubject(subject,"utf-8");
		MimeMessage newMessage = new MimeMessage((MimeMessage)message);
		String emailAddress = seller.getSystemEmail().getEmailAddress();
